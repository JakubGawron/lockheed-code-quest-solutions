...
def generate_orderings(parts, used_part, orderings, built_expr):
...
for _ in range(int(input())):
    ...
    candidate_numbers = sorted(map(int, input().split(",")), reverse=True)
    ...
    final_list = sorted(combo_set, key=parse_numbers)
